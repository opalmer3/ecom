...
export type CollectionsQuery = { collections: { pageInfo: Pick<StorefrontTypes.PageInfo, 'hasNextPage' | 'endCursor'>, edges: Array<(
      ...
      & { node: (
        ...
        & { image?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'id' | 'altText' | 'url'>>, metafield?: StorefrontTypes.Maybe<{ reference?: StorefrontTypes.Maybe<{ image?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'url' | 'altText'>> }> }>, products: { pageInfo: Pick<StorefrontTypes.PageInfo, 'hasNextPage' | 'endCursor'>, edges: Array<(
            Pick<StorefrontTypes.ProductEdge, 'cursor'>
            & { node: (
              Pick<StorefrontTypes.Product, 'id' | 'title' | 'handle' | 'description'>
              & { collections: { edges: Array<{ node: Pick<StorefrontTypes.Collection, 'title' | 'handle'> }> }, featuredImage?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'altText' | 'url'>>, priceRange: { minVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> } }
            ) }
...
export type ProductByHandleQuery = { product?: StorefrontTypes.Maybe<(
    Pick<StorefrontTypes.Product, 'availableForSale' | 'description' | 'descriptionHtml' | 'tags' | 'totalInventory' | 'id' | 'title' | 'handle'>
    & { collections: { edges: Array<{ node: (
        ...
        ) }> }, metafields: Array<StorefrontTypes.Maybe<Pick<StorefrontTypes.Metafield, 'id' | 'key' | 'value'>>>, featuredImage?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'altText' | 'url'>>, priceRange: { minVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> } }
  )> };
